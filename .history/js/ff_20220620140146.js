...
const articles = [
  ...
  {"date": ".2", "name": "from the publishers: delegation"},
  {"date": ".2", "name": "your business review: there’s no better time"},
  {"date": ".4", "name": "owning your building: is it practical?"},
  {"date": ".6", "name": "credit card perks: free airline travel"},
  {"date": ".7", "name": "by the books: tips on managing holiday volume: short on space?"},
  {"date": ".8", "name": "inquiries & answers: cash flow"},
  {"date": ".8", "name": "inquiries & answers: giving away that old car"},
  {"date": ".8", "name": "norms: monthly sales"},
