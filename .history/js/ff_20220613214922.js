const ff = [
  {
    ...
    l4: "cash flow forecasting: knowledge is power",
    l6: "cut your payroll: key to seasoned success",
    l7: "by the books: non-holiday staffing analysis—know what you can afford",
    l8: [
  ...
  },
  {
    ...
    l4: "your business plan: the how & the why",
    l6: "the family business: perks—getting something for nothing",
    l7: "by the books: smart buying—a key to profitability",
    l8: [
  ...
  },
  {
    ...
    l4: "$776,487 in sales: $2,830 in profit",
    l6: "the family business: family relationships",
    l7: "by the books: your advertising budget—allocating advertising dollars",
    l8: [
  ...
  },
  {
    ...
    l4: "you & your corporation: how's the relationship going?",
    l6: "money smarts: savings strategies",
    l7: "by the books: gift card accounting: do it right",
    l8: [
  ...
  },
  {
    ...
    l4: "evaluating advertising: making your investment pay",
    l6: "by the books: traditional wedding protocol: a checklist for guidance",
    l8: [
  ...
  },
  {
    ...
    l4: "shop profile: making money in february: one florist’s story",
    l6: "finding the help you need: the challenge—the solution",
    l7: "by the books: punching in early … staying late",
    l8: [
  ...
  },
  {
    ...
    l4: "owning your building: is it practical?",
    l: "credit card perks: free airline travel",
    l7: "by the books: tips on managing holiday volume: short on space?",
    l8: [
